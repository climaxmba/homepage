import admindashboardSrc from "./img/admindasboard.jpg";
import battleshipSrc from "./img/battleship.jpg";
import contactLSrc from "./img/contactImgL.jpg";
import contactSSrc from "./img/contactImgS.jpg";
import knightTravailsSrc from "./img/knighttravails.jpg";
import personLSrc from "./img/personimgL.jpg";
import personSSrc from "./img/personimgS.jpg";
import restaurantPageSrc from "./img/restaurantpage.jpg";
import todoSrc from "./img/todolist.jpg";
...
<section id="about-sectn">
    <picture id="person-img">
        <source media="(min-width: 500px)" srcset="${personLSrc}">
        <img src="${personSSrc}" alt="">
    </picture>
...
<section id="projects-sectn">
    ...
    <ul id="projects-contr">
        <li>
            <img src="${battleshipSrc}" alt="" class="projectsimg">
        ...
        <li>
            <img src="${weatherApp}" alt="" class="projectsimg">
            <div class="project-details">
                <div class="project-name-nav">
                    <h3>Weather App</h3>
                    <div class="btns-contr">
        ...
        <li>
            <img src="${todoSrc}" alt="" class="projectsimg">
            <div class="project-details">
                <div class="project-name-nav">
                    <h3>Todo App</h3>
                    <div class="btns-contr">
        ...
        <li>
            <img src="${knightTravailsSrc}" alt="" class="projectsimg">
            <div class="project-details">
                <div class="project-name-nav">
        ...
        <li>
            <img src="${restaurantPageSrc}" alt="" class="projectsimg">
            <div class="project-details">
                <div class="project-name-nav">
        ...
        <li>
            <img src="${admindashboardSrc}" alt="" class="projectsimg">
            <div class="project-details">
                <div class="project-name-nav">
...
<section id="contact-sectn">
    ...
    <picture id="person-second-img">
        <source media="(min-width: 500px)" srcset="${contactLSrc}">
        <img src="${contactSSrc}" alt="">
    </picture>
</section>`;
